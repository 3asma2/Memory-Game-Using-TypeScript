...
prepare.cards = [];
prepare.progress = 0;
prepare.fullTrack = new Audio('./materials/audio/fulltrack.mp3');
prepare.flipAudio = new Audio('./materials/audio/flip.mp3');
prepare.goodAudio = new Audio('./materials/audio/good.mp3');
prepare.failAudio = new Audio('./materials/audio/fail.mp3');
prepare.gameOverAudio = new Audio('./materials/audio/game-over.mp3');
...
for (let index = 0; index < numberOfCards / 2; index++) {
    prepare.cards.push({
        ...
        src: `./materials/images/${index}.jpg`,
        flip: '',
        clickable: true,
        index
    });
        ...
        <div onclick="toggleFlip(${index})" class="card-flip">
            <div id="card-flip-${index}">
                <div class="front">
                    <!-- front content -->
                    <div class="card">
                        <img class="card-image" src="./materials/back.jpg" alt="Loading...">
                ...
                <div class="back">
                    <!-- back content -->
                    <div class="card">
                        <img src="./materials/images/${item.index}.jpg" alt="Image [100%x180]" data-holder-rendered="true"
